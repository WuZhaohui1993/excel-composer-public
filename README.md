...
![来源文件解析：工作表、字段和数据预览](docs/assets/excel-source-cards.png)

### 字段组合：主表、补充表、匹配关系与输出列

![字段组合：主表、补充表、匹配关系与输出列](docs/assets/excel-field-map.png)

### 拖拽组合：配置关系并生成预览

![拖拽组合：配置关系并生成预览](docs/assets/excel-drag-preview.png)

### 结果工作区：问题数量、预览与导出

![结果工作区：问题数量、预览与导出](docs/assets/excel-result.png)
